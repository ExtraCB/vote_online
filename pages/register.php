        ...
        <div class="card">
          ...
          <div class="card-body">
            <form action="./../services/register.php" method="post">
              ...
              <input type="text" name="password-confirm" class="form-control mb-2" id="" required>

              <div class="row row-cols-2 p-3">
                <input type="submit" value="Register" name="register_submit" class="btn btn-outline-primary">

                <a href="./../pages/login.php">เป็นสมาชิกอยู่แล้ว</a>
              </div>
